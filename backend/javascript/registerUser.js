...
async function main() {
    ...
    try {
       ...
       //console.log(`Successfully registered user ${userID} and imported it into the wallet`);
        ...
        const registerUserResponse = await contract.submitTransaction('RegisterUser', userID, userType);
        if (registerUserResponse){
            console.log(`Successfully registered user ${userID} of type ${userType} and imported into the wallet.`);
        } else{
